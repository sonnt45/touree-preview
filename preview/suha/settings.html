        ...
        <div class="settings-wrapper py-3">
          ...
          <div class="card settings-card">
            <div class="card-body">
              <!-- Single Settings-->
              <div class="single-settings d-flex align-items-center justify-content-between">
                <div class="title"><i class="fa-solid fa-circle-check"></i><span>Availability</span></div>
                <div class="data-content">
                  <div class="toggle-button-cover">
                    <div class="button r">
          ...
          <div class="card settings-card">
            <div class="card-body">
              <!-- Single Settings-->
              <div class="single-settings d-flex align-items-center justify-content-between">
                <div class="title"><i class="fa-solid fa-bell"></i><span>Notifications</span></div>
                <div class="data-content">
                  <div class="toggle-button-cover">
                    <div class="button r">
                      <input class="checkbox" type="checkbox" checked>
          ...
          <div class="card settings-card">
            <div class="card-body">
              <!-- Single Settings-->
              <div class="single-settings d-flex align-items-center justify-content-between">
                <div class="title"><i class="fa-solid fa-language"></i><span>Language</span></div>
                <div class="data-content"><a href="language.html">English<i class="fa-solid fa-angle-right"></i></a></div>
              </div>
            </div>
          </div>
          <!-- Single Setting Card-->
          <div class="card settings-card">
            <div class="card-body">
              ...
              <div class="single-settings d-flex align-items-center justify-content-between">
                ...
                <div class="data-content"><a href="support.html">Get Help<i class="fa-solid fa-angle-right"></i></a></div>
              </div>
            </div>
          </div>
          <!-- Single Setting Card-->
          <div class="card settings-card">
            <div class="card-body">
              ...
              <div class="single-settings d-flex align-items-center justify-content-between">
                ...
                <div class="data-content"><a href="privacy-policy.html">View<i class="fa-solid fa-angle-right"></i></a></div>
              </div>
            </div>
          </div>
          <!-- Single Setting Card-->
          <div class="card settings-card">
            <div class="card-body">
              ...
              <div class="single-settings d-flex align-items-center justify-content-between">
                ...
                <div class="data-content"><a href="change-password.html">Change<i class="fa-solid fa-angle-right"></i></a></div>
              </div>
            </div>
          </div>
        </div>
